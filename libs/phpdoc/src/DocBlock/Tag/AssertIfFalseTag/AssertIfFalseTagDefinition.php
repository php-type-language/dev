 ...
 *
 * ```
 * "@assert-if-false" <Type> <Variable> [ <Description> ]
 * ```
 */
final class AssertIfFalseTagDefinition extends TagDefinition
{
    public const string NAME = 'assert-if-false';
    ...
    public function create(string $name, TagPayload $result): AssertIfFalseTag
    {
        ...
        return new AssertIfFalseTag($name, $type, $variable, $description);
    }
}
