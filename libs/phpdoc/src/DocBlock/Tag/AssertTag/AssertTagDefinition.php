 ...
 *
 * ```
 * "@assert" <Type> <Variable> [ <Description> ]
 * ```
 */
final class AssertTagDefinition extends TagDefinition
{
    ...
    public function create(string $name, TagPayload $result): AssertTag
    {
        ...
        return new AssertTag($name, $type, $variable, $description);
    }
}
