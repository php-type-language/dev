...
/**
 * Splits a DocBlock comment into its significant segments: the meaningful
 * lines of text with their byte offsets, stripped of the comment framing
 * (leading indentation, asterisks, and blank lines).
 *
 * Implemented with plain string functions rather than regular expressions.
 */
