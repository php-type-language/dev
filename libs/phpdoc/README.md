...
- [x] `@copyright` - Documents the copyright information of any _Element_
  > `"@copyright" [ <Description> ]`
- [x] `@deprecated` - Marks an _Element_ as deprecated, optionally since a given version
  > `"@deprecated" [ <Version> ] [ <Description> ]`
- [x] `@extends` - Specifies generic type arguments for an inherited class or interface
  > `"@extends" <Type> [ <Description> ]`
- [x] `@final` - Declare any _Element_ as final
  > `"@final" [ <Description> ]`
- [x] `@implements` - Specifies generic type arguments for an implemented interface
  > `"@implements" <Type> [ <Description> ]`
- [ ] `@immutable` - Declares a class as immutable
  > `"@immutable" [ <Description> ]`
- [x] `@inheritdoc` - Inherits documentation from the overridden or implemented _Element_
...
- [x] `@template-use` - Specifies generic type arguments for a used trait
...
**Non-Standard (Advanced)**

- [x] `@no-named-arguments` - Indicates that argument names may change in the future
  > `"@no-named-arguments" [ <Description> ]`
- [ ] `@not-deprecated` - Marks an _Element_ as explicitly not deprecated, overriding an inherited `@deprecated`
...
- [x] `@pure-unless-callable-is-impure` - Declares a callable as pure unless one of its callable arguments performs side effects
...
- [ ] `@phan-assert-true-condition` - Asserts that the given expression is true at the point of call
...
- [ ] `@language`
  > `"@language" <Name>`
- [ ] `@expectedException` - Declares the `\Throwable` a test method is expected to throw
  > `"@expectedException" <Type> [ <Description> ]`
- [ ] `@formatter:off` - Disables automatic code formatting from this point on
  > `"@formatter:off"`
- [ ] `@formatter:on` - Re-enables automatic code formatting from this point on
  > `"@formatter:on"`
