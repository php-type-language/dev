...
final class MissingPropertyWriteException extends PropertyNotWritableException
{
    public static function becausePropertyDoesNotExist(object $ctx, string $property, ?\Throwable $prev = null): self
    {
        $message = \sprintf('The %s::$%s property does not exist and cannot be written', $ctx::class, $property);
