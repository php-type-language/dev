 ...
 *
 * @see \TypeLang\Node\Stmt\Attribute\AttributeGroupsListNode
 * @see \TypeLang\Node\Stmt\Attribute\AttributeGroupNode
 * @see \TypeLang\Node\Stmt\Attribute\AttributeNode
 */
